...
public class MNetworkUtils {
    ...
    private MNetworkUtils() {
        throw new UnsupportedOperationException("u can't instantiate me...");
    }

    private static Context context = MFrame.getContext();

    public enum NetworkType {
        /**
         * wifi, 4g, 3g, 2g, 无法判断, 没有网络
         */
        NETWORK_WIFI,
        NETWORK_4G,
        NETWORK_3G,
     ...
     * @return 网络类型
     * <ul>
     * <li>{@link MNetworkUtils.NetworkType#NETWORK_WIFI   } </li>
     * <li>{@link MNetworkUtils.NetworkType#NETWORK_4G     } </li>
     * <li>{@link MNetworkUtils.NetworkType#NETWORK_3G     } </li>
     * <li>{@link MNetworkUtils.NetworkType#NETWORK_2G     } </li>
     * <li>{@link MNetworkUtils.NetworkType#NETWORK_UNKNOWN} </li>
     * <li>{@link MNetworkUtils.NetworkType#NETWORK_NO     } </li>
     * </ul>
     */
