package com.pangmao.mframe.utils.handler;
...
public class MHandler {
     ...
     */
    public MHandler(@Nullable Handler.Callback callback) {
     ...
     * @param callback The callback interface in which to handle messages, or null.
     */
    public MHandler(@NonNull Looper looper, @NonNull Handler.Callback callback) {
        mCallback = callback;
