 ...
 */
public class MStateButton extends AppCompatTextView {
    //text color
    ...
    public MStateButton(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.buttonStyle);
    }

    public MStateButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setup(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.MStateButton);
        ...
        mNormalTextColor = a.getColor(R.styleable.MStateButton_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.MStateButton_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.MStateButton_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.MStateButton_animationDuration, mDuration);
...
//        mUnableBackground.setCornerRadius(mRadius);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.MStateButton_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.MStateButton_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.MStateButton_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.MStateButton_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.MStateButton_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.MStateButton_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.MStateButton_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.MStateButton_unableStrokeColor, 0);
        setStroke();
